...
public class NXTRemoteControl extends Activity implements OnSharedPreferenceChangeListener {
    ...
    private void setupUI() {
        if (mControlsMode == MODE_BUTTONS) {
            ...
            ImageButton buttonKU = (ImageButton) findViewById(R.id.button_ku);
            buttonKU.setOnTouchListener(new DirectionButtonOnTouchListener(0, 0, 1));

            ImageButton buttonKD = (ImageButton) findViewById(R.id.button_kd);
            buttonKD.setOnTouchListener(new DirectionButtonOnTouchListener(0, 0, -1));
